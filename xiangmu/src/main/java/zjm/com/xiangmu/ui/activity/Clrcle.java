...
public class Clrcle extends ImageView{
    private Paint paint = new Paint();

    public Clrcle(Context context) {
        super( context );
    }

    public Clrcle(Context context, @Nullable AttributeSet attrs) {
        super( context, attrs );
    }

    public Clrcle(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
